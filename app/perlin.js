...
export const noise = (() => {
    ...
    noise.perlin3 = function(x, y, z) {
      ...
      const n010 = gradP[X + 1 + perm[Y + perm[Z]]].dot3(x - 1, y, z);
      const n011 = gradP[X + 1 + perm[Y + perm[Z + 1]]].dot3(x - 1, y, z - 1);
      const n100 = gradP[X + perm[Y + 1 + perm[Z]]].dot3(x, y - 1, z);
      const n101 = gradP[X + perm[Y + 1 + perm[Z + 1]]].dot3(x, y - 1, z - 1);
